...
#let note-style = builder-thmline(color: colors.at(6), titlefmt: strong
)
#let note = note-style("note", "Note").with(numbering: none)

#let warning-style = builder-thmline(color: colors.at(14), titlefmt: strong)
#let warning = warning-style("warning", "Warning").with(numbering: none)
